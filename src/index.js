...
function generatePoem(event) {
  ...
  let prompt = `Generate a short poem about ${instructionsInput.value}. Try to recognize language of provided topic`;
  ...
  poemElement.innerHTML = `<div class="generating">⏳ Generating a romantic poem about ${instructionsInput.value}</div>`;
